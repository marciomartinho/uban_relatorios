// JavaScript para Detalha Conta Contábil Despesa - Versão DuckDB com Filtros em Cascata
console.log('Arquivo detalha_despesa.js carregado - Versão com filtros em cascata');
...
function carregarFiltros() {
    ...
    $.ajax({
        url: '/detalha-despesa/api/filtros',
        method: 'GET',
...
function configurarEventos() {
    ...
    $('#selectAno').on('change', function() {
        ...
        if (ano) {
            ...
            $.ajax({
                url: '/detalha-despesa/api/contas-por-ano',
                method: 'GET',
                data: { ano: ano },
                success: function(data) {
    ...
    $('#selectConta').on('change', function() {
        ...
        if (ano && conta) {
            ...
            $.ajax({
                url: '/detalha-despesa/api/ugs-por-ano-conta',
                method: 'GET',
                data: { 
                    ano: ano,
                    conta: conta 
    ...
    tabelaDados = $('#tabelaDados').DataTable({
        ...
        initComplete: function() {
            ...
            this.api().columns().every(function(index) {
                ...
                // Adicionar filtros apenas nas colunas: Mês, Documento, Evento, Natureza, Conta Corrente
